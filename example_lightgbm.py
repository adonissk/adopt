...
def main():
    """Example usage of the Bayesian Hyperparameter Optimizer."""
    ...
    optimizer = BayesianHyperparameterOptimizer(
        model_type="lightgbm",
        experiment_name="lightgbm_regression_example",
        ...
        # Wandb logging
        use_wandb=True,
        wandb_project="lightgbm-bayesian-optimization",
        wandb_entity=None  # Use default entity
    )
    
    print(f"Experiment ID: {optimizer.experiment_id}")
    
    # Setup experiment with default LightGBM search space
